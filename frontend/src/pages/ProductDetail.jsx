            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.98 }}
                  transition={{ duration: 0.4, ease: [0.25, 1, 0.5, 1] }}
                  className={`group h-[50px] px-6 flex items-center justify-center gap-2.5 rounded-xl transition-all duration-300 font-black uppercase tracking-widest text-[11px] ${isSold ? "opacity-50 pointer-events-none bg-gray-100 text-gray-400" : "bg-[#EDF9F1] text-[#1EAE58] border border-[#25D366]/30 hover:bg-[#25D366] hover:text-white hover:border-[#25D366]"}`}
                >
                  <div className={`flex items-center justify-center w-7 h-7 rounded-full transition-colors duration-300 shrink-0 ${isSold ? "bg-gray-200 text-gray-400" : "bg-[#25D366]/15 text-[#1EAE58] group-hover:bg-white/20 group-hover:text-white"}`}>
