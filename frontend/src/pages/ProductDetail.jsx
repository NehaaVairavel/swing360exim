            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}>
              ...
              <div className="grid grid-cols-2 gap-[14px] mt-[18px]">
                <button
                  ...
                  disabled={isSold}
                  className={`h-[54px] px-6 flex items-center justify-center gap-2 rounded-[16px] font-bold uppercase tracking-[1px] text-[16px] transition-all duration-300 ${isSold ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-[#f5a000] text-white shadow-xl shadow-[#f5a000]/20 hover:-translate-y-1 hover:shadow-2xl"}`}
                >
                ...
                <a 
                  ...
                  className={`h-[54px] px-6 flex items-center justify-center gap-2 rounded-[16px] transition-all duration-300 font-bold uppercase tracking-[1px] text-[16px] ${isSold ? "opacity-50 pointer-events-none" : "bg-[#eaf9ef] text-[#1fa855] border border-[#cdeed7] hover:bg-[#1fa855] hover:text-white"}`}
                >
